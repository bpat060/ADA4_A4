...
/**
 * A class which contains the strongly connected components algorithm for a
 * graph that implements GraphADT interface and whose vertices hold elements of
...
public class StronglyConnectedComponents<E> {
    ...
    public Set<Set<Vertex<E>>> getComponentVertices() {
        ...
        while (!vertexStack.empty()) {
            ...
            if (visitedVertices != null && visitedVertices.size() > 0) {  // obtain a corresponding list of the original vertices
